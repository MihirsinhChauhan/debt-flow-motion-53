...
>(({ className, ...props }, ref) => (
  <h3
    ref={ref}
    className={cn(
      "text-mobile-heading sm:text-xl font-semibold leading-tight tracking-tight",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={cn("text-mobile-body text-muted-foreground leading-relaxed", className)}
    {...props}
  />
))
