...
const AIRecommendationsDisplay: React.FC<AIRecommendationsDisplayProps> = ({
  ...
  // Sort recommendations by priority score (with null check)
  const sortedRecommendations = (recommendations || []).slice().sort((a, b) => b.priority_score - a.priority_score);
      ...
      <div className="space-y-4">
        ...
        {sortedRecommendations.length > 0 ? (
          ...
          <Card className="p-6 text-center border-dashed">
            ...
            <p className="text-gray-600 mb-2">No AI recommendations available</p>
            <p className="text-sm text-gray-500">
              Check back later for personalized debt optimization strategies
            </p>
          </Card>
        )}
      </div>
